...
{
    public class StateEmailBuilder
    {
        public IEmailBuilder AddReceiverAndBody(string receiver, string body)
        {
            return new SimpleEmailBuilder(receiver, body);
        }

        private class SimpleEmailBuilder : IEmailBuilder
        {
